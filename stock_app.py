...
# Vérifie si on veut forcer un rafraîchissement
# Gérer le rafraîchissement uniquement si demandé
...
if not row.empty:
    ...
    if st.button("🗑️ Supprimer ce lot"):
        ...
        df_stock.to_excel(stock_file, index=False)
        st.success("✅ Lot supprimé avec succès. Cliquez sur le bouton ci-dessous pour rafraîchir l’interface.")
